...
#python main.py --path ../dataset/isolet.pickle --d 1000 --alg rp-sign --epoch 20
#python main.py --path ../dataset/isolet.pickle --d 1000 --alg idlv --epoch 20 --L 64 
#python main.py --path ../dataset/isolet.pickle --d 1000 --alg perm --epoch 20 --L 64 
